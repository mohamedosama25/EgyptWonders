places = [
        ...
        "hotels": [
            {
                ...
                "price": "$272 - $421 per night"
            },
            {
                "name": "Steigenberger Pyramids Cairo",
                "price": "$140 - $260 per night"
            },
            {
    ...
    },
    {
        ...
        "imagesrc": "https://drifttravel.com/wp-content/uploads/2023/12/drifttravel_Khan_El_Khalili_Bazaar_in_Cairo_f5910bbd-7b61-4f7d-bad5-98d1d3500b99-copy.webp",
        "description": "Located in the heart of Islamic Cairo, Khan El Khalili is one of the oldest and most famous markets in the Middle East. Established in the 14th century, this bustling bazaar is a labyrinth of narrow streets filled with shops and stalls selling a wide range of goods, including jewelry, spices, souvenirs, traditional crafts, and textiles. The market’s vibrant atmosphere is enhanced by the sounds of haggling vendors and the aroma of exotic spices and incense. It’s an ideal place to experience local culture, shop for unique items, and enjoy traditional Egyptian street food. Historic coffeehouses like El Fishawi, which has been in operation for over 200 years, offer a place to relax and soak in the ambiance.",
        "price": {
            "Entry": "Free"
        },
        "hours": "Typically open from morning until late evening, with peak times in the afternoon and early evening.",
        "hotels": [
            {
                "name": "Le Riad - Tell a Story Boutique Hotel",
    ...
    },
    {
        "id": 4,
        "name": "Al-Azhar Park",
        "imagesrc": "https://elfatheec.com/wp-content/uploads/2017/08/Azhar-Park-1.png",
        "description": "Al-Azhar Park is a stunning green oasis in the middle of Cairo, offering panoramic views of the city’s skyline. Opened in 2005, the park was developed on a former landfill and has become one of Cairo's most beautiful public spaces. It features well-maintained gardens, fountains, and shaded walkways, providing a serene environment for relaxation and recreation. The park also houses several restaurants and cafes that offer picturesque views of the city, including the historic mosques and minarets of Islamic Cairo. Al-Azhar Park is a perfect place for a leisurely stroll, picnics, and family outings.",
        "price": {
            "Entry": {
                "Egyptian": 10,
                "Foreign": 20
    ...
    },
    {
        "id": 5,
        "name": "Coptic Cairo",
        "imagesrc": "https://jakadatoursegypt.com/wp-content/uploads/2020/12/Hanging-Church.jpg.webp",
        "description": "Coptic Cairo is a historic area that is home to some of the oldest Christian churches in Egypt, dating back to the early centuries of Christianity. Notable landmarks include the Hanging Church (Saint Virgin Mary's Coptic Orthodox Church), which is one of the oldest and most famous Coptic churches in Cairo, and the Church of St. Sergius and Bacchus, believed to be built on the spot where the Holy Family rested during their flight to Egypt. The area also includes the Coptic Museum, which houses a rich collection of Coptic art and artifacts. Coptic Cairo provides a serene contrast to the bustling city, offering a glimpse into Egypt’s Christian heritage and religious history.",
        "price": {
            "Entry": "Free"
        },
        "hours": "Generally from 9:00 AM to 4:00 PM",
        "hotels": [
            {
                "name": "Hotel Grand Royal",
    ...
    },
    {
        ...
        "hotels": [
            {
                "name": "Iberotel Cairo Hotel & Casino",
    ...
    },
    {
        "id": 12,
        "name": "Saqqara",
        "imagesrc": "https://www.cleopatraegypttours.com/wp-content/uploads/2018/07/pyramid-of-Djoser.jpg",
        "description": "Saqqara is an extensive ancient burial ground located south of Cairo, famous for its Step Pyramid of Djoser, which is the oldest complete stone building complex known in history. Designed by the architect Imhotep, the Step Pyramid dates back to the Third Dynasty (circa 2670-2650 BC) and marks a significant development in the evolution of pyramid construction. Saqqara contains numerous pyramids and tombs of varying sizes and states of preservation, spanning different dynasties of ancient Egypt. The site provides a fascinating glimpse into early pyramid construction and the elaborate burial practices of ancient Egyptian civilization.",
        "price": {
            "General Entry": {
                "Egyptian": 30,
                "Student": 10,
    ...
    },
    {
        ...
        "hotels": [
            {
                "name": "Marriott Cairo Hotel & Omar Khayyam Casino",
    ...
    },
    {
     ...
     "price": {
        "Beverages and Snacks": "You can enjoy sweet corn, sweet potato, halabesa, or beverages like coffee and tea from street vendors.",
        "Prices": "Prices typically range from 10 to 50 EGP, depending on the item and vendor."
    },
        "hours": "Open 24 hours",
        "hotels": [
            {
    ...
    },
    {
        ...
        "price": {
            "Entry": "Free",
            "Prices": "Prices vary according to the cafe you choose."
        },
        "hours": "Open 24 hours",
        "hotels": [
            {
    ...
    , {
        ...
        "hours": "Typically open during daylight hours, with markets operating from early morning to late evening.",
        "hotels": [
            {
                "name": "Golden Jewel Hotel",
    ...
    },
    {
        ...
        "price": {
            "Entry": "Free",
            "Prices": "Prices vary based on the menu options available at the time of your visit"
        },
    ...
    },
    {
        ...
        "hotels": [
            {
                "name": "Hotel Novotel Sharm El Sheikh",
                "price": "$90 - $180 per night"
            },
            {
                "name": "Aqua Blu Sharm El Sheikh",
                "price": "$120 - $220 per night"
            }
        ]
    },
    {
        ...
        "hotels": [
            ...
            {
                "name": "Le Royale Collection Luxury Resort",
                "price": "$140 - $280 per night"
            }
        ]
    },
    {
        ...
        "price": {
            "Prices": "Prices vary depending on the menu items"
        },
        "hours": "10:00 AM to 11:00 PM",
        "hotels": [
            {
            ...
            {
                "name": "Albatros Palace Resort Sharm",
                "price": "$180 - $350 per night"
            }
        ]
    },
    ...
    },
    {
        ...
        "hotels": [
            {
                "name": "Maritim Jolie Ville Resort & Casino",
                "price": "$150 - $300 per night"
            },
            {
                "name": "Sheraton Sharm Hotel, Resort, Villas & Spa",
                "price": "$130 - $260 per night"
            }
        ]
    },
    ...
    },
    {
        ...
        "hotels": [
            {
                "name": "Fatnas Island Ecolodge",
                "price": "$100 - $180 per night"
            },
            {
                "name": "Siwa Dream Hotel",
                "price": "$90 - $150 per night"
            },
            {
                "name": "Oasis Panorama",
    ...
    },
    {
        ...
        "hours": "Tours typically run from morning to evening, with overnight camping options available.",
        "hotels": [
            {
                "name": "Desert Rose Hotel",
                "price": "$80 - $140 per night"
    ...
    },
    {
        ...
        "hotels": [
            {
                "name": "Bir Wahed Resort",
                "price": "$100 - $180 per night"
            },
            {
                "name": "Siwa Dream Lodge",
                "price": "$90 - $150 per night"
            },
            {
                "name": "Salt Lake Retreat",
                "price": "$120 - $200 per night"
            }
        ]
    },
